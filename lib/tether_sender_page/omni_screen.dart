...
class OmniScreen extends StatefulWidget {
  const OmniScreen({Key? key}) : super(key: key);

  @override
  _OmniScreenState createState() => _OmniScreenState();
}

class _OmniScreenState extends State<OmniScreen> {
